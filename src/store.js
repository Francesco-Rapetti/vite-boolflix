...
export const store = reactive({
    ...
    apiAiringTodaySeries: `https://api.themoviedb.org/3/tv/airing_today?api_key=${apiKey}&page=`,
    apiOnTheAirSeries: `https://api.themoviedb.org/3/tv/on_the_air?api_key=${apiKey}&page=`,
    apiPopularSeries: `https://api.themoviedb.org/3/tv/popular?api_key=${apiKey}&page=`,
    apiTopRatedSeries: `https://api.themoviedb.org/3/tv/top_rated?api_key=${apiKey}&page=`,
    movies: [],
    series: [],
    search: '',
    home: true,
